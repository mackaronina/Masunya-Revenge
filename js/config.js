...
но и всего мира`,
            deathCount: 'Смертей:',
            ending: `В результате террористической атаки на завод пилка зверски убито 46 
сотрудников завода. Также был безвозвратно утерян рецепт пилка, в связи 
с чем завод не сможет возобновить производство. Полиция Некославии начала 
расследование`
        }
    }
}
